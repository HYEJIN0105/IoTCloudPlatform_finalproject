...
public class GetLog extends GetRequest {
    ...
    class Tag {
        ...
        public Tag(String temp, String led,String hum, String buz, String time) {
            temperature = temp;
            LED = led;
            humidity= hum;
            BUZZER= buz;
        ...
        public String toString() {
            return String.format("[%s] Temperature: %s, Humidity: %s, LED: %s, BUZZER: %s", timestamp, temperature, humidity,LED,BUZZER);
        }
    }
}
