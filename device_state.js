...
var invokeAPI = function() {
    ...
    var API_URI = 'https://bj71cf430b.execute-api.ap-northeast-2.amazonaws.com/prod/devices/MyMKRWiFi1010';                 
    $.ajax(API_URI, {
        method: 'GET',
...
var printData = function(result){      
    document.getElementById("result").innerHTML = "temperature: "+ result.state.reported.temperature + 
                                                " , humidity: "+ result.state.reported.humidity +  
                                                ", LED: " + result.state.reported.LED +
                                                ", BUZZER: " + result.state.reported.BUZZER;
